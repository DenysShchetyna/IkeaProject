...
namespace Ikea_Library.HdevProcedures
{
    public class CamProcedures
    {
        ...
        public void OpenFramegrabber(HTuple cameraName, HTuple offsetX, HTuple offsetY, HTuple width, HTuple height, HTuple exposureTime, out HTuple acqHandle)
        {
            OpenFramegrabber_Call.SetInputCtrlParamTuple("cameraName", cameraName);
            OpenFramegrabber_Call.SetInputCtrlParamTuple("OffsetX", offsetX);
            OpenFramegrabber_Call.SetInputCtrlParamTuple("OffsetY", offsetY);
